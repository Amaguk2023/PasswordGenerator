...
def pwd_decryption():
    ...
    while not private_decrypt_key:
        try:
            ...
            print('''\nPossible errors: Private key or password file does not exist. Private key bits are not enough 
for encryption (please select ZH from the menu for more information about encryption).''')
            private_decrypt_key = False
